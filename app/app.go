...
import (
	...
	dexmodule "Everstake_demo2/x/dex"
	dexmodulekeeper "Everstake_demo2/x/dex/keeper"
	dexmoduletypes "Everstake_demo2/x/dex/types"
	everstakedemo2module "Everstake_demo2/x/everstakedemo2"
	everstakedemo2modulekeeper "Everstake_demo2/x/everstakedemo2/keeper"
	everstakedemo2moduletypes "Everstake_demo2/x/everstakedemo2/types"
	// this line is used by starport scaffolding # stargate/app/moduleImport

	appparams "Everstake_demo2/app/params"
	"Everstake_demo2/docs"
)

const (
	AccountAddressPrefix = "EverstakeDemo"
	Name                 = "Everstake_demo2"
)
...
var (
	...
	ModuleBasics = module.NewBasicManager(
		...
		everstakedemo2module.AppModuleBasic{},
...
type App struct {
	*baseapp.BaseApp
	...
	Everstakedemo2Keeper everstakedemo2modulekeeper.Keeper
...
func New(
	...
	keys := sdk.NewKVStoreKeys(
		...
		everstakedemo2moduletypes.StoreKey,
	...
	*/
	...
	app.Everstakedemo2Keeper = *everstakedemo2modulekeeper.NewKeeper(
		appCodec,
		keys[everstakedemo2moduletypes.StoreKey],
		keys[everstakedemo2moduletypes.MemStoreKey],
		app.GetSubspace(everstakedemo2moduletypes.ModuleName),
	)
	everstakedemo2Module := everstakedemo2module.NewAppModule(appCodec, app.Everstakedemo2Keeper, app.AccountKeeper, app.BankKeeper)
	...
	app.mm.SetOrderBeginBlockers(
		...
		everstakedemo2moduletypes.ModuleName,
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(everstakedemo2moduletypes.ModuleName)
